    ...
    if input("是否修改身份证号? (y/n): ").lower() == "y":
        ...
        if new_id_number:
            ...
            existing_employee_by_id = EmployeeInfo.query.filter(
                EmployeeInfo.id_number == new_id_number, EmployeeInfo.employee_number != employee_number_to_update
            ).first()
    ...
    if input("是否修改电话号码? (y/n): ").lower() == "y":
        ...
        if new_phone_number:
            ...
            existing_employee_by_phone = EmployeeInfo.query.filter(
                EmployeeInfo.phone_number == new_phone_number, EmployeeInfo.employee_number != employee_number_to_update
            ).first()
