...
class VectorDataViewingResource(Resource):
    ...
    def get(self):
        ...
        return {
            "status": True,
            "data": {"list": items, "pages": {"total": pagination.total, "pages": pagination.pages}},
        }, 200
...
class ShpDataListResource(Resource):
    ...
    def get(self):
        ...
        return {"status": True, "data": [item.to_dict() for item in pagination.items], "total": pagination.total}, 200
...
class MapSearchResource(Resource):
    ...
    def get(self):
        ...
        # Database results (data records matching the keyword)
