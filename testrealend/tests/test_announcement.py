...
class TestAnnouncements:
    ...
    def test_create_announcement(self, client, auth_headers):
        resp = client.post(
            ...
            json={"title": "Test Announcement", "content": "This is a test", "type": "info"},
        )
    ...
    def test_update_announcement(self, client, auth_headers):
        ...
        create_resp = client.post(
            "/api/admin/announcements", headers=auth_headers, json={"title": "To Update", "content": "Original"}
        )
        if create_resp.status_code in (200, 201):
            ...
            if ann_id:
                resp = client.put(
                    ...
                    headers=auth_headers,
                    json={"title": "Updated", "content": "Modified"},
                )
                assert resp.status_code == 200
