...
ext_message_clean = crmark.decode_bits(stego_clean_image)
...
is_attacked, rec_cover_attacked, rec_message_attacked = crmark.recover_bits(stego_attack_image)
ext_message_attacked = crmark.decode_bits(stego_attack_image)
