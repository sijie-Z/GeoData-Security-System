...
if __name__ == '__main__':
    watermarked_shpfile_path = r"E:\flaskproject\testrealendol\algorithm\embed\11WuJiang\11WuJiang.shp"
    vr = [120.77672262824791, 31.48174406581425]
    output_shapefile_path, output_watermark_path = extract(watermarked_shpfile_path, vr)
    watermark1 = image_to_array(output_watermark_path)

    # 评估NC值

    original_watermark_path = r"C:\Users\kangsumeng\Desktop\下载 (1).png"
    original_watermark = image_to_array(original_watermark_path)
    nc = NC(original_watermark, watermark1)
    print(nc)
